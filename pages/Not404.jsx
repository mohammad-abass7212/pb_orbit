...
const Not404 = () => {
  return (
    ...
    <div> <h1 className='font-bold text-7xl text-[#00E276]'>404 </h1> </div>
    ...
    <div className='m-auto sm:w-96 text-center font-bold text-[#6C6290] py-4 '>
        ...
        Lorem Ipsum is simply dummy text of the printing and type Lorem Ipsum is simply dummy text of the printing and typesetting industry. setting industry.</p>
    </div>
    
    
    
    <div className="m-auto py-4 mb-20 ">
    <button className='bg-[#00E276] p-3 rounded-lg px-10 sm:px-28' >Back to Dashboard</button>
    </div>
    <p>
