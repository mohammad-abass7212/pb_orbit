...
const SignupForm: React.FunctionComponent<ISignupProps> | any = () => {
  ...
  const handleSubmit = async (event: any) => {
    ...
    try {
      const response = await axios.post(
        "http://34.148.83.101:5000/player/signup",
        {
          username: "surendra12311",
          email: "surendr2aye@gmail.com",
          password: "surendra11231",
          country_code: "+91",
          mobile_number: "857427088",
          social_login: false,
        }
      );
