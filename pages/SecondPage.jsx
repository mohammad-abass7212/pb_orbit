...
const onclick=()=>{
  ...
  return (
    <div className="flex gap-10">
      <div className={drop1?"w-1/6 border-r-2 pb-5 hidden sm:block":"w-1/12 border-r-2 pb-5 hidden sm:block"} >
        <LoyoutDror onclick={onclick} drop1={drop1}  />
      </div>
      <div className="w-[80%] py-5" >
      <div className=" border-b-2 pb-5 ">
<div  className="flex justify-end" >  <img src="/utils/common/Avatar.png" alt="" /> </div> 
